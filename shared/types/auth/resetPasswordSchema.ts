...
const resetPasswordSchema = v.pipe(v.object({
  password: v.pipe(
    v.string(),
...
type InferedResetPasswordSchema = v.InferOutput<typeof resetPasswordSchema>

export { resetPasswordSchema }
export type { InferedResetPasswordSchema }
